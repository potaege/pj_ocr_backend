...
from app.ocr.filter_world.help_filter.eng_date import convert_english_date # แก้
from app.ocr.filter_world.help_filter.name_lastName_th import name_lastname_th
from app.ocr.filter_world.help_filter.name_lastName_eng import name_lastname_eng
from app.ocr.filter_world.help_filter.registrar__driving_license_thai import find_province_from_registrar
from app.ocr.filter_world.data.address.loader_address import load_provinces
PROVINCES = load_provinces()

import json
def receive_driving_license_data(ocr_data: dict):
